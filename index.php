        ...
        <div class="container">
            ...
            <div class="row mt-5">
                <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="card shadow-lg mb-2">
                        <div class="card-body text-center">
                            <img src="images/user1.jpeg" class="img-fluid" style="border-radius: 100px;">
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="card shadow-lg mb-2">
                        <div class="card-body text-center">
                            <img src="images/user2.jpeg" class="img-fluid" style="border-radius: 100px;">
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="card shadow-lg mb-2">
                        <div class="card-body text-center">
                            <img src="images/user3.jpeg" class="img-fluid" style="border-radius: 100px;">
                ...
                <div class="col-lg-3 col-sm-6">
                    ...
                    <div class="card shadow-lg mb-2">
                        <div class="card-body text-center">
                            <img src="images/user4.jpeg" class="img-fluid" style="border-radius: 100px;">
    ...
    <div class="container" id="Contact">
        ...
        <div class="row">
            ...
            <div class="col-md-4 text-center">
                ...
                OSMS Pvt Ltd, <br>
                132 C Sector, Indrapuri, Bhopal <br>
                Madhya Prades - 462022 <br>
                Phone: +7004987522 <br>
                <a href="#" target="_blank">www.osms.com</a> <br>

                <br><br>
                <strong>Bengalore Branch:</strong> <br>
                OSMS Pvt Ltd, <br>
                132 C Sector, Indrapuri, Bhopal <br>
                Madhya Prades - 123456 <br>
                Phone: +62.5531358 <br>
                <a href="/" target="_blank">www.osms.com</a> <br>
